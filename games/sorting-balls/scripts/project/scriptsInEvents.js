...
const scriptsInEvents = {
	...
	async Gamesheet_Event45_Act1(runtime, localVars)
	{
		variation = 0;
	},

	async Gamesheet_Event47_Act1(runtime, localVars)
	{
		variation = 0;
	},

	async Gamesheet_Event51_Act1(runtime, localVars)
	{
		variation = 0;
	},

	async Gamesheet_Event139_Act1(runtime, localVars)
	{
