...
class Boot extends Phaser.Scene {
    ...
    preload() {
      ...
      //  this.load.bitmapFont("Panton", "assets/fonts/Panton40.png", "assets/fonts/Panton40.fnt")
	    this.load.bitmapFont("Panton", "assets/fonts/riffic50all.png", "assets/fonts/riffic50all.fnt")
...
class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        var resources = {
			...
			/*
            json: [
                ["alltext", "assets/text/textRussia.json?r=" + MyMath.getRandomInt(0, 99)]
            ]*/
        };
