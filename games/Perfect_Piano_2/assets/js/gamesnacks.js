! function(e) {
    ...
    var a, o = {
        ...
        S = function(e) {
            ...
            return _(t, e), t.instance = new t, t
        }(s),
        g = function() {
            function e(e) {
                var t = this;
                this.environment = "production", this.audioEnabled = !0, this.shouldAudioBeEnabledAfterAd = !0, this.isAdInProgress = !1, this.audioSubscribers = [], this.ghostDataSubscriber = null, this.adsInitialized = !1, this.rewardedAdsAllowed = !1, this.rewardedAdName = "", this.forceVerbose = !1, this.sendScore = function(e, n) {
                    ...
                    if (t._logIfVerbose("initialize AdSense with config " + JSON.stringify(e, null, 2)), !t.adsInitialized) {
                        ...
                        n.setAttribute("data-ad-client", e.publisherId), n.setAttribute("data-ad-frequency-hint", e.dataAdFrequencyHint), n.setAttribute("src", e.afgSdkUrl), "on" === e.dataAdbreakTest && n.setAttribute("data-adbreak-test", "on"), e.channelId && n.setAttribute("data-ad-channel", e.channelId), window.document.head.appendChild(n), window.adsbygoogle = window.adsbygoogle || [], window.adBreak = window.adConfig = function(e) {
                    ...
                    t._logIfVerbose("calling adbreak."), window.adBreak && window.adBreak(a)
